...
//import mg.orange.automatisation.entities.Appareil;
...
//				
//			//serveur		
//			PServeur pserveur = serv.findById(Long.valueOf(serveur)).get();
//			
//			//tester connexion
...
//							for (DockerCon conf : dserv_element.getDockerConfig()) {
//								dconf.delete(conf);
//							}   
