...
//	public static void DeployerReseau(Reseau reseau, Utilisateur user,PServeur serv) throws serveurException, reseauException
//	{
//		try {
//				//connexion
...
//	
//	//trouver IP libre
//	public static List<IP> scannerIp(IP reseau, int Masque, int nb_adresse, List<IP> Ip_occuper, Utilisateur user, PServeur serv) throws sshException, serveurException
//	{
//		//Ip à scanner
...
//
//	////ping
//	private static boolean ping(String adresse, Utilisateur user, PServeur serv) throws serveurException
//	{		
//		try {
