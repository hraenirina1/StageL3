...
//	}
//	
//	public static List<DockerServeur> configurer(Utilisateur user, PServeur serv, BDServeur bd,int nb_docker,String ram, String cpu, List<Config> configBase,List<IP> ip_dao) throws serveurException, ConfigException
//	{
...
//					List<DockerCon> dconf = new ArrayList<>();
//					
...
//									
//									case "WSREP_ON":
//										dconf.add(new DockerCon(conf1, "ON"));									
//										break;
//									
//									case "WSREP_PROVIDER":
//										dconf.add(new DockerCon(conf1, "/usr/lib64/galera/libgalera_smm.so"));	
//										break;
//									
//									case "WSREP_PROVIDER_OPTIONS":
//										dconf.add(new DockerCon(conf1, ""));	
//										break;
//										
...
//										};
//										
//										dconf.add(new DockerCon(conf1, valeur + "'"));	
//										break;					
//										
//									case "WSREP_CLUSTER_NAME":
//										dconf.add(new DockerCon(conf1, "'" + bd.getNomBdServeur() + "'"));	
//										break;
//										
//									case "WSREP_NODE_ADDRESS":
//										dconf.add(new DockerCon(conf1, "'" + adresseIpInterne.get(i-1) + "'"));
//										break;
//										
//									case "WSREP_NODE_NAME":
//										dconf.add(new DockerCon(conf1, "'" + docker.getNom_docker_serveur() + "'"));	
//										break;
//										
//									case "WSREP_SST_METHOD":
//										dconf.add(new DockerCon(conf1, "rsync"));	
//										break;
//										
//									case "BINLOG_FORMAT":
//										dconf.add(new DockerCon(conf1, "row"));	
//										break;
//										
//									case "DEFAULT_STORAGE_ENGINE":
//										dconf.add(new DockerCon(conf1, "InnoDB"));	
//										break;
//										
//									case "INNODB_AUTOINC_LOCK_MODE":
//										dconf.add(new DockerCon(conf1, "2"));	
//										break;
//										
//									case "BIND_ADDRESS":
//										dconf.add(new DockerCon(conf1, "0.0.0.0"));	
//										break;
//										
//									case "MYSQL_ROOT_PASSWORD":
//										dconf.add(new DockerCon(conf1, bd.getMysqlPasssword()));	
//										break;
//
//									default:
