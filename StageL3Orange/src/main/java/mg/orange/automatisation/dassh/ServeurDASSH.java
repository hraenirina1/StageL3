...
//	}
//	
//	public static String[] listeSauvegarde( Utilisateur user, PServeur serv) throws serveurException
//	{
//		try {
//				String[] list;
//				
...
//	}
//	
//	public static void miseEnPlaceIp(IP ip, String interface_serveur, Utilisateur user, PServeur serv) throws serveurException
//	{
//		try {
//				//connnexion
//				SshConnection sshCon = SshConnection.CreerConnection(new SshConfig(user));		
